"""This program is meant to have the user input two variables and then show the user using those two variables how four of the relational operators work in Python."""
