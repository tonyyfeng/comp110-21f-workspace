...
def slay_dragon():
    ...
    attack: int = 10
    health: int = 100
    dragon_health: int = 200
    dragon_damage: int = 15
    death: int = 0
    i: int = 0
    attack_type: str = ""
            ...
            while did_they_attack == 0:
                ...
                if attack_type == "1":
                    ...
                    if attack_type == "2":
                        ...
                        if will_it_succeed == 1:
                            print(f"You successfully disabled the dragon!, it is now dealing half the damage it was before!")
                            dragon_damage = (dragon_damage / 2)
                        else:
                            print(f"Your shot completely missed lol.")
                        did_they_attack = 1
                    else:
                        print("You did not attack, please select a valid answer: 1, or 2")
        if dragon_health > 0:    
